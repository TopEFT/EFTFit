...
text2workspace.py EFT_MultiDim_Datacard.txt -P EFTFit.Fitter.EFT16DModel:eft16D --PO fits=$CMSSW_BASE/src/EFTFit/Fitter/data/16D_Parameterization.npy -o test.root
combine -M MultiDimFit -v 3 test.root --cminDefaultMinimizerStrategy 0 --cminDefaultMinimizerTolerance 0.1
