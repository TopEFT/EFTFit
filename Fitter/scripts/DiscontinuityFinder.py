...
systematics = ['CERR1','CERR2','CMS_eff_em','CMS_scale_j','ChargeFlips','FR_FF','LEPID','Q2FR','PDF','PSISR','PU',
               'QCDscale_V','QCDscale_VV','QCDscale_VVV','QCDscale_tHq','QCDscale_ttG','QCDscale_ttH','QCDscale_ttV',
...
for entry in range(2,limitTree.GetEntries()): # 0 is the fit point, so ignore it
    ...
    if(abs(deltaNLLcurr-deltaNLLprev)/deltaNLLprev > 0.03):
        print("Found deltaNLL discontinuity between {} [{},{}]".format(args.poi,poiprev,poicurr))
