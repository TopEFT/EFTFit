...
plotter.BatchOverlayLLPlot1DEFT(basename_lst=['.081121.njet.16wc.Float'], basename2_lst=['.EFT.SM.Freeze'], wcs=[], log=False, final=False, titles=['Others profiled', 'Others fixed to SM'])
```
